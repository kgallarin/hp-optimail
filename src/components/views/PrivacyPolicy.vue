<template>
  <div class="static-pages">
    ...
    <header-text class="xmd">Information Collected Through the Aff Builder Services</header-text>
    <p>
    ...
    <p>
      Aff Builder will not use or disclose your personal information without consent. Therefore, users are asked to agree to these Privacy Policy and Terms of Service. These data are necessary for Aff Builder to properly identify you as a user in our platform and provide you with personalized user experience.
    </p>
    <p>
      We do not sell, trade or rent your personal information to third parties. All personal information provided by you are handled in accordance with the legal requirements and interest solely for Aff Builder.
    </p> 
    
    <header-text class="xmd">Data Storage Period</header-text>
    <p>Aff Builder will store your personal data as long as it is necessary and required for the user experience functionality. In some cases, personal data may be stored for longer periods if the personal data is required to protect our client and third parties legitimate interests.</p>
    ...
    <p>Aff Builder maintains industry standard procedures to safeguard and protect data in our possession from breach of security, misuse and unauthorised access. Transmitting highly confidential information such as credit card details are well protected through encryption such as Secure Socket Layer (SSL) protocol.</p>
