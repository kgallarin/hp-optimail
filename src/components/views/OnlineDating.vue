<template>
  <div class="features-wrapper">
    ...
    <data-protection 
      ...
      :text-desc="
        [
          'Online dating has been classified as high-risk, making these services unsuitable for merchant accounts at numerous banks. Aff Builder has a vast network of banking partners that accept online dating services and can provide competitive rates. '
        ]
      "
    ...
    <security 
      ...
      text-desc="Dating sites must offer a multitude of services, depending on the needs of every type of customer., Give users the quickest way to start any subscription or package and search for love using Aff Builder: "
    ...
    <contact 
      ...
      :text-desc="
        [
          'It is essential for your users that they feel safe when using your dating site. That is why Aff Builder offers confidential payment confirmation. You can remove your dating site name from the payment confirmation sent to the user so that the user can keep his online dating activities a secret.'
        ]
      "
    />
    ...
    <data-protection 
      ...
      :text-desc="
        [
          ...
          'Since most users tend to use phones for texting on online dating sites, the same users should be able to make payments through their phones. Offering mobile payments with Aff Builder will have a direct positive impact on your revenue.'
        ]
      "
    />
          ...
          dating_list: [
              {
                  ...
                  icon: ['fas','book-open'],
                  block_text:'The online dating industry has a higher-than-average number of chargebacks. Maintaining a low chargeback ratio is critical because if chargebacks exceed the maximums, the merchant account becomes at risk of being shut down by the banks. Aff Builder is an expert when it comes to chargeback management and can guide you to self-regulate and establish industry best practices. '
              },
              {
                  id: 1,
              ...
              },
              {
                  ...
                  icon:['fas','users'],
                  block_text:'Online dating companies usually need more than one merchant account to support their varied services. Aff Builder can manage multiple merchant IDs organized under one main MID account.'
              }
