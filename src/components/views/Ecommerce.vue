<template>
  <div class="features-wrapper">
    ...
    <security 
      ...
      text-desc="We tick all the boxes, so why look further. It doesn't matter if you're looking to expand into international markets, managing subscription packages or just want to boost conversion rates, HydroPay can help with all your needs and the complexities of global digital commerce. But first, get the right criteria filled"
