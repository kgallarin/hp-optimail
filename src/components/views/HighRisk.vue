<template>
  <div class="features-wrapper">
    ...
    <!-- section 3 -->
    <data-protection 
      header-text="With Aff Builder, you'll get treated equally"
      :text-desc="
        [
      ...
      return {
          ...
          hr_blueList: [
              ...
              },
              {
                  ...
                  title: 'Step 2',
                  icon:['fas','cloud'],
                  block_text:'You go looking for a new partner who specializes in high-risk merchant accounts and came across Aff Builder.'
              },
              {
                  id: 2,
                  title: 'Step 3',
